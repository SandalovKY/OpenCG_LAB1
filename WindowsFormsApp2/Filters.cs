...
namespace WindowsFormsApp2
{
    ...
    abstract class Filters
    {
        ...
        public abstract myPixel calculateNewPixelColor(byte[] sourceBuffer, int stride, int height, int x, int y); // абстрактный метод фильтра в родительском классе
        public virtual Bitmap processImage(Bitmap sourceImage, BackgroundWorker worker) // проходим циклом по исходному изображению и применяем фильтр
        {
