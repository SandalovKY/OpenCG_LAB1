...
namespace WindowsFormsApp2
{
    public partial class Form1 : Form
    {
       ...
       private void sobelToolStripMenuItem_Click(object sender, EventArgs e)
       {
        ...
        private void schurToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        {
            {
                int sizey = Int32.Parse(textBox1.Text);
                int sizex = Int32.Parse(textBox2.Text);
                MorphOps.mask = new float[sizey, sizex];
                for(int i = 0; i < sizey; ++i)
                {
                    for(int j = 0; j < sizex; ++j)
                    {
                        MorphOps.mask[i, j] = 0f;
                    }
                }
                DataGridViewColumn[] colarr = new DataGridViewColumn[sizex];
                for (int i = 0;  i < sizex; ++i)
                {
                    colarr[i] = new DataGridViewColumn(dataGridView1[0, 0]);
                }
                dataGridView1.Columns.Clear();
                for (int i = 0; i < sizex; ++i)
                {
                    dataGridView1.Columns.Add(colarr[i]);
                }
                for (int i = 0; i < sizey; ++i)
                {
                    dataGridView1.Rows.Add();
